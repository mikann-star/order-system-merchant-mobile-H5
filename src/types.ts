...
export interface Dish { id: string; name: string; englishName?: string; category: string; price: number; stock?: number; recommended?: boolean; discount?: number; status: DishStatus; estimatedCost?: number; description?: string; keywords?: string; specs?: DishSpecGroup[] }
